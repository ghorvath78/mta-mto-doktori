...
export const DecisionTextInput = ({ fieldKey, fieldDescr }: FieldInputProps) => {
    ...
    return (
        <div className={baseClass}>
            <label className={`block mb-1 font-medium text-primary-foreground ${labelClass}`} htmlFor={fieldKey}>
                {label}
            </label>
            <Textarea
                rows={lines}
